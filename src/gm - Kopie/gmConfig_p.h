...
#define GM_FORCEINLINE        inline // __forceinline
#define GM_INLINE             inline
#define _gmstricmp            strcasecmp // stricmp
#define _gmsnprintf           snprintf // _snprintf
#define _gmvsnprintf          vsnprintf // _vsnprintf
#ifdef _DEBUG
#define GM_DEBUG_BUILD
#endif // _DEBUG
#define GM_PRINTF             printf
