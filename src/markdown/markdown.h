...
int  mkd_line(char *, int, char **, DWORD);
int  mkd_generateline(char *, int, FILE*, DWORD);
#define mkd_text mkd_generateline
void mkd_basename(Document*, char *);

typedef int (*mkd_sta_function_t)(const int,const void*);
void mkd_string_to_anchor(char*,int, mkd_sta_function_t, void*, int, DWORD);

Document *mkd_in(FILE *, DWORD);
Document *mkd_string(const char*,int, DWORD);

Document *gfm_in(FILE *, DWORD);
Document *gfm_string(const char*,int, DWORD);
