...
PYLONC_API GENAPIC_RESULT PYLONC_CC PINVOKE
PylonGigEIssueActionCommand( const char* pSubnetAddress, uint32_t DeviceKey, uint32_t GroupKey, uint32_t GroupMask, uint32_t Timeout_ms,  PINVOKE_RETVAL_PAR uint32_t* NumResults );


PYLONC_API GENAPIC_RESULT PYLONC_CC PINVOKE
PylonGigEIssueScheduledActionCommand( const char* pSubnetAddress, uint32_t DeviceKey, uint32_t GroupKey, uint32_t GroupMask, uint64_t Actiontime_ns, uint32_t Timeout_ms,  PINVOKE_RETVAL_PAR uint32_t* NumResults );
