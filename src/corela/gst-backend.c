...
void backend_pause(void) { gst_element_set_state (pipeline, GST_STATE_PAUSED); }

void backend_resume(void) { gst_element_set_state (pipeline, GST_STATE_PLAYING); }

void backend_seek(int value) { gst_element_seek (pipeline, 1.0, GST_FORMAT_TIME, seek_flags, GST_SEEK_TYPE_CUR, value * GST_SECOND, GST_SEEK_TYPE_NONE, GST_CLOCK_TIME_NONE); }

void backend_seek_absolute(long long value) { gst_element_seek (pipeline, 1.0, GST_FORMAT_TIME, seek_flags, GST_SEEK_TYPE_SET, value * 1000000, GST_SEEK_TYPE_NONE, GST_CLOCK_TIME_NONE); }
